...
def main():
    ...
    model_relu_history = model_relu.fit(x_train, y_train, epochs = 5, batch_size = 512, verbose = 0)
    print('\n')
    model_sig_history = model_sig.fit(x_train, y_train, epochs = 5, batch_size = 512, verbose = 0)
